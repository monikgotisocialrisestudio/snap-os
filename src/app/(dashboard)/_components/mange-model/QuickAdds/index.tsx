...
function QuickAdds(props: propType) {
    ...
    return (
        <div className="mt-12">
            <div>
                <div className="text-base font-normal">Number of Quick Adds</div>
                    ...
                    <div className="w-[40%]">
                        <Range
                            ...
                            renderThumb={({ props }) => (
                                <div
                                    {...props}
                                    className="h-4 w-4 bg-blue-500 rounded-full border-none focus:outline-none focus:ring-blue-500"
                                />
                            )}
                        />
                    </div>
